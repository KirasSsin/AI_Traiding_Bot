...
> **Инвентарь кита (авто, 2026-07-02):** агентов **18** (~/.claude/agents) · проектных скиллов **9** (.claude/skills) · superpowers-скиллов **14** · хуков подключено: PreToolUse(Bash) **14** + UserPromptSubmit **2** + SessionStart **3**; sh-файлов хуков на диске **17**.
<!-- /AUTO:kit-inventory -->
...
## Sections 14-24 → Part 2

**File split в S32e** (per CLAUDE.md sec 9 size threshold 50KB). Sections 14-24 moved к [[tooling-inventory-ru-part-2]].

| Section | Topic | Anchor |
|---------|-------|--------|
| 14 | Permission modes (default/auto/sandbox) | [[tooling-inventory-ru-part-2#14-permission-modes-per-anthropic-best-practices]] |
| 15 | Plugin curation (4 active) | [[tooling-inventory-ru-part-2#15-plugin-curation-4-active]] |
| 16 | CLI tools (explicit list) | [[tooling-inventory-ru-part-2#16-cli-tools-explicit-list]] |
| 17 | Status line (`/statusline`) | [[tooling-inventory-ru-part-2#17-status-line--context-tracking-statusline]] |
| 18 | Token-saver commands | [[tooling-inventory-ru-part-2#18-token-saver-commands-binding--best-practices]] |
| 19 | Non-interactive + fan-out | [[tooling-inventory-ru-part-2#19-non-interactive-mode--fan-out-patterns]] |
| 22 | Memory corpus categorization scheme (S32c) | [[tooling-inventory-ru-part-2#22-memory-corpus-categorization-scheme-s32c--partial-bridge-4-design]] |
| 23 | anthropic-skills:schedule wire (S32d) | [[tooling-inventory-ru-part-2#23-anthropic-skillsschedule-wire-к-audit_formulaspy-s32d]] |
| 24 | Memory corpus bridges 2-4 research (S32d) | [[tooling-inventory-ru-part-2#24-memory-corpus-bridges-2-4--feasibility-research-notes-s32d]] |

## Связанные документы

- [[tooling-inventory-ru-part-2]] — Part 2 (Sections 14-24, NEW S32e split)
...
- [[../decisions/0047-sprint-32c-kit-phase-2-improvements]] — Kit Phase 2 (S32c)
- [[../decisions/0048-sprint-32d-kit-phase-3-improvements]] — Kit Phase 3 final (S32d)
