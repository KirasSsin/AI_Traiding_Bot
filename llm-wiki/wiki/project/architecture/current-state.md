...
| Component pages | **38** | `wiki/project/components/*.md` (incl. README.md cluster index) | S13 — S25 + S27 + S28 + S29 + S30 added zero components |
| ADRs | **43** | `wiki/project/decisions/*.md` (0001-0043) | S30 (ADR 0043 — Tier-2 agents + cascade) |
| Sprint pages | **30** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-30 + sprint-08a/b/c, minus S24+S26) | S30 (sprint-30-tier-2-agents-mem-wiki-merge) |
| Reviewer agents | **9** | `~/.claude/agents/` (out-of-repo) | S30 +3 tier-2 (security-auditor / test-engineer / doc-reviewer) |
| Active hooks | **6** | `~/.claude/hooks/` (adr-agent / adr-index / wiki-broken-link / caveman / sprint-flow / phase-advance) | S30 +phase-advance.sh |
