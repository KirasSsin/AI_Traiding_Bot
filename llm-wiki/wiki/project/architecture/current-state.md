...
| Component pages | **38** | `wiki/project/components/*.md` (incl. README.md cluster index) | S13 — S25 + S27 + S28 added zero components |
| ADRs | **41** | `wiki/project/decisions/*.md` (0001-0041) | S28 (ADR 0041 — Process enforcement) |
| Sprint pages | **28** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-28 + sprint-08a/b/c, minus S24+S26) | S28 (sprint-28-process-enforcement) |
