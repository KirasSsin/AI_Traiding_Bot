...
# Current State (post-S39, 2026-05-09) — volume_breakout production integration shipped (tag v0.1.0-alpha.39 PENDING)
...
| Reason codes | **53** | `src/risk/reason_codes.py` `ReasonCode` enum | S39 A1 (+3 ENTRY_LONG_VOLUME_BREAKOUT / EXIT_FLAT_VOLUME_CHANNEL / EXIT_FLAT_ATR_STOP_VB per ADR 0059) |
| Component pages | **47** | `wiki/project/components/*.md` (excl. README.md cluster index) | S39 (+volume-breakout-strategy) |
...
| ADRs | **59** | `wiki/project/decisions/*.md` (0001-0059) | S39 (ADR 0059 volume_breakout pre-registration LOCKED) |
| Sprint pages | **43** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-39 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S39 (sprint-39-volume-breakout-tech-debt) |
...
Expected output: `states=16, events=30, transitions=74, reason_codes=53`
