...
| ADRs | **50** | `wiki/project/decisions/*.md` (0001-0050) | S33 (ADR 0050 — Trading Restart F BACKTEST FAIL conjoint) |
| Sprint pages | **37** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-33 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S33 (sprint-33-trading-restart) |
