...
# Current State (post-S42, 2026-05-10) — atr_breakout production hardening (tag v0.1.0-alpha.42)
...
| ADRs | **62** | `wiki/project/decisions/*.md` (0001-0062) | S42 (ADR 0062 atr_breakout hardening — supersedes 0060+0061) |
| Sprint pages | **46** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-42 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S42 (sprint-42-atr-breakout-hardening) |
