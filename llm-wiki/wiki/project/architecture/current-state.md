...
# Current State (post-S43, 2026-05-10) — UI polish (preset rename + equity chart, tag v0.1.0-alpha.43)
...
| ADRs | **63** | `wiki/project/decisions/*.md` (0001-0063) | S43 (ADR 0063 UI polish) |
| Sprint pages | **47** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-43 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S43 (sprint-43-ui-polish) |
