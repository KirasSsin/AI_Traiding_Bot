...
| Component pages | **43** | `wiki/project/components/*.md` (incl. README.md cluster index) | unchanged S32e |
| Architecture pages | **+2 NEW S32e** | `wiki/project/architecture/{kit-audit-2026-04-27,tooling-inventory-ru-part-2}.md` | kit-audit (NEW) + tooling-inventory split (part 2 NEW) |
| ADRs | **49** | `wiki/project/decisions/*.md` (0001-0049) | S32e (ADR 0049 — Kit audit + doc sync) |
| Sprint pages | **36** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-32 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S32e (sprint-32e-kit-audit-doc-sync) |
