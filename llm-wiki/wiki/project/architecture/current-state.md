...
# Current State (post-S41, 2026-05-10) — ATR breakout multi-combo presets shipped (tag v0.1.0-alpha.41)
...
| ADRs | **61** | `wiki/project/decisions/*.md` (0001-0061) | S41 (ADR 0061 atr_breakout multi-combo presets) |
| Sprint pages | **45** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-41 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S41 (sprint-41-atr-breakout-multi-combo) |
