...
| Component pages | **45** | `wiki/project/components/*.md` (incl. README.md cluster index) | S35 (+halt-gate + donchian-strategy) |
...
| ADRs | **54** | `wiki/project/decisions/*.md` (0001-0054) | S35 (ADR 0053 δ TESTNET + ADR 0054 α Donchian pre-registration) |
| Sprint pages | **39** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-35 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S35 (sprint-35-testnet-donchian-risk) |
