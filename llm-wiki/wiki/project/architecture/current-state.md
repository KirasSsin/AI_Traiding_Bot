...
# Current State (post-S40, 2026-05-10) — atr_breakout production integration shipped (tag v0.1.0-alpha.40)
...
| ADRs | **60** | `wiki/project/decisions/*.md` (0001-0060) | S40 (ADR 0060 atr_breakout pre-registration LOCKED) |
| Sprint pages | **44** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-40 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S40 (sprint-40-atr-breakout-production) |
