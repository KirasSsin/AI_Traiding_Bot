...
# Current State (post-S37, 2026-04-27) — δ TESTNET production-ready (tag v0.1.0-alpha.37)
...
| ADRs | **57** | `wiki/project/decisions/*.md` (0001-0057) | S37 (ADR 0057 carry-overs hardening) |
| Sprint pages | **41** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-37 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S37 (sprint-37-carry-overs-hardening) |
