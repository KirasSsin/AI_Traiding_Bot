...
# Current State (post-S36, 2026-04-27) — δ TESTNET WIRED LIVE (tag v0.1.0-alpha.36)
...
| Reason codes | **49** | `src/risk/reason_codes.py` `ReasonCode` enum | S36 T5 (+4 HALT_S36_DD_INTRADAY/DD_MULTIDAY/CONSECUTIVE_LOSSES/NO_TRADE_TIMEOUT) |
| Component pages | **47** | `wiki/project/components/*.md` (incl. README.md cluster index) | S36 (+halt-gate-wireup + live-trade-reporter) |
...
| ADRs | **56** | `wiki/project/decisions/*.md` (0001-0056) | S36 (ADR 0055 δ activation + ADR 0056 DSR sigma_SR amendment) |
| Sprint pages | **40** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-36 + sprint-08a/b/c + sprint-32b/c/d/e, minus S24+S26) | S36 (sprint-36-delta-activation) |
...
Expected output: `states=16, events=30, transitions=74, reason_codes=49`
