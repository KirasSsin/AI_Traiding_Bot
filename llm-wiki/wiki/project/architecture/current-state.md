...
| Component pages | **43** | `wiki/project/components/*.md` (incl. README.md cluster index) | S32d +3 (bybit-api-reviewer-agent + context-budget-hook + sprint-metrics) |
| ADRs | **48** | `wiki/project/decisions/*.md` (0001-0048) | S32d (ADR 0048 — Kit Phase 3 final) |
| Sprint pages | **35** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-32 + sprint-08a/b/c + sprint-32b/c/d, minus S24+S26) | S32d (sprint-32d-kit-phase-3-improvements) |
