...
| Component pages | **38** | `wiki/project/components/*.md` (incl. README.md cluster index) | S13 — S25 + S27 + S28 + S29 added zero components |
| ADRs | **42** | `wiki/project/decisions/*.md` (0001-0042) | S29 (ADR 0042 — Superpowers integration) |
| Sprint pages | **29** | `wiki/project/sprints/sprint-*.md` (sprint-01..sprint-29 + sprint-08a/b/c, minus S24+S26) | S29 (sprint-29-superpowers-integration) |
