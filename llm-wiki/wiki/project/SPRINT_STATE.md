...
| 4 Execute | in_progress | T1 done. T2 done. T3 done. T5 done (7d1177b — ReasonCode 45→49 + property test GREEN). pytest 821 unit + 8 property / mypy 0 / canonical reason_codes=49. T4 + T6-T8 pending. |
