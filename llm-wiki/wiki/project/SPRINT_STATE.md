...
| 4 Execute | in_progress | T1-T4 done. T5 done (29f0075 — Coordinator.symbol public property + 5 fixture updates coord._symbol → coord.symbol). pytest 861 unit + 33 integration / mypy 0. T6-T8 pending. |
