...
| 4 Execute | in_progress | T1 done. T2 done (654ef66 + reviewer fixes — HALT_UNKNOWN_SYMBOL 49→50 + fail-closed semantic + whitelist + startup banner + case normalization). pytest 850 unit / mypy 0 / canonical reason_codes=50. T3-T8 pending. |
