...
def test_total_reason_codes_count():
    assert (
        len(ReasonCode) == 67
    )  # 31 (S5) +8 (S6 ADR 0020) +3 (S7 ADR 0021) +3 (S8a ADR 0022) +4 (S36 ADR 0055) +1 (S37 ADR 0057) +3 (S39 ADR 0059) +3 (S40 ADR 0060) +7 (S49 H6 ADR 0023 amendment) +2 (S50 ADR 0067 Supertrend) +2 (S52 ADR 0068 Kronos)
