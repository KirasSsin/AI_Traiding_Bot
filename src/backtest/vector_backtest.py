...
class VectorBacktester:
    ...
    """
    def __init__(self, df: pd.DataFrame, initial_capital: float = 10000.0, maker_fee: float = 0.001):
        self.df = df.copy()
    ...
    def run(self) -> dict:
        ...
        sharpe_ratio = (returns_mean / returns_std) * np.sqrt(365 * 24 * 60) if returns_std != 0 else 0
